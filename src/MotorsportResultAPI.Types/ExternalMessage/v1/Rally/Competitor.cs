...
namespace MotorsportResultAPI.Types.ExternalMessage.v1.Rally
{
	public class Competitor
	{
		...
		private readonly List<MotorsportResultAPI.Types.Domain.v1.Rally.StageResult> c_stageResults;
		...
		public List<MotorsportResultAPI.Types.Domain.v1.Rally.StageResult> StageResults { get { return this.c_stageResults; } }
		...
		public Competitor(
			...
			string car,
			string category,
			List<MotorsportResultAPI.Types.Domain.v1.Rally.StageResult> stageResults)
		{
			//DBC
